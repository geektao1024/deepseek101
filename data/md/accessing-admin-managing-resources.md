---
title: Accessing the Admin Panel and Managing Resources in LemoBook
description: How to access the admin panel and manage your resource list in LemoBook
...
---
# Accessing the Admin Panel and Managing Resources in LemoBook

LemoBook provides a user-friendly admin interface for managing your website's resources. This guide will walk you through the process of accessing the admin panel and managing your resources effectively.

## Accessing the Admin Panel

1. **Navigate to the Admin URL**: Open your web browser and go to your LemoBook website's URL, followed by `/admin`. For example: `https://yourlemobooksite.com/admin`.
...
Note: The current version of LemoBook might not support direct deletion through the admin interface. If you need to remove a resource:
...
LemoBook automatically syncs your changes with the GitHub repository configured in your environment variables. After making changes:
...
1. **Regular Backups**: Although LemoBook uses GitHub for version control, it's a good practice to periodically backup your `resources.json` file.
...
By following these steps, you should be able to effectively manage the resources on your LemoBook website through the admin panel. Remember, all changes are version-controlled through GitHub, allowing you to track modifications and revert if necessary.
